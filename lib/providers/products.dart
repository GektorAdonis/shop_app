...
class Products with ChangeNotifier {
  List<Product> _items = [
    ...
    //   price: 29.99,
    //   imageUrl:
    //       'https://cdn.pixabay.com/photo/2016/10/02/22/17/red-t-shrt-1710578_1280.jpg',
    // ),
    // Product(
    //   id: 'p2',
    //   title: 'Trousers',
  ...
  Future<void> fetchAndSetProducts() async {
    final url = Uri.parse(
        'https://shop-app-new-default-rtdb.firebaseio.com/products.json');
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    final url = Uri.parse(
        'https://shop-app-new-default-rtdb.firebaseio.com/products/$id.json');
